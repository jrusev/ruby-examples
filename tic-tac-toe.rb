...
# This implementation splits functionality into four classes: Game, Player, HumanPlayer, and ComputerPlayer. 
# A game can be played between any combination of HumanPlayers and ComputerPlayers.
# The AI for the computer uses certain heuristics to ensure that it never loses,
# but the AI is not as aggressive as it could be. 
# The AI defends against the opening corner trap, but does not exploit it in its offense.
